...
registrationForm.addEventListener('submit', async (event) => {
  ...
  const data = { ...fields, ...identity, fullName, styles: [...registrationForm.querySelectorAll('[name="styles"]:checked')].map((x) => x.value), undertaking: [...registrationForm.querySelectorAll('[name="undertaking"]:checked')].map((x) => x.value) };
